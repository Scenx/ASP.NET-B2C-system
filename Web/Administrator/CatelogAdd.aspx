<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CatelogAdd.aspx.cs" Inherits="Administrator_CatelogAdd" %>
       ...
       <div id="LoginCon">
                <table width="940px" border="1" cellpadding="1" cellspacing="1" bordercolor="#E1E1E1">
                    <tr>
                        ...
                        <td width="255px">
                            <input type="text" name="textfield" id="ProID" runat="server"  onfocus="this.className='textboxfocus'" onblur="this.className='textboxout'" class="textboxout" />
                    ...
                    <tr>
                        ...
                        <td width="255px">
                           ...
                           <span class="Login_ErroRound" id="RoundItemMemberPrice">*</span>
                        </td>
                        <td width="536" class="Login_span">
