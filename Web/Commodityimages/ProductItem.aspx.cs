...
public partial class ProductItem : System.Web.UI.Page
{
    ...
    protected void ReTitle()
    {
        ...
        switch (txtCategory)
        {
            ...
            case "Coat":
                txtTitle = "外 套  电子商务系统网";
                break;
            case "Computer":
                txtTitle = "电 脑  电子商务系统网";
                break;
            case "HuFu":
                txtTitle = "护 肤  电子商务系统网";
                break;
            case "MianMo":
                txtTitle = "面 膜  电子商务系统网";
                break;
            case "MP3":
                txtTitle = "MP3  电子商务系统网";
                break;
            case "PeiShi":
                txtTitle = "配 饰  电子商务系统网";
                break;
            case "Shirt":
                txtTitle = "衬 衫  电子商务系统网";
                break;
            case "ShouJi":
                txtTitle = "手 机  电子商务系统网";
                break;
            case "Skirt":
                txtTitle = "裙 子  电子商务系统网";
                break;
            case "Soprts":
                txtTitle = "运动鞋  电子商务系统网";
                break;
            case "TouShi":
                txtTitle = "头 饰  电子商务系统网";
                break;
            default:
                txtTitle = "拖鞋  电子商务系统网";
                break;
