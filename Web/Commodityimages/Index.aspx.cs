...
public partial class _Default : System.Web.UI.Page
{
    ...
    public void BindCommend() {
        ...
        for (int i = 0; i < item.Count; i++) {
            ...
            builder.Append("<dd class=\"FontOne\">" + SubNameTwo(item[i].ItemName) + "</dd><dd class=\"FontTwo\">VIP:"+item[i].VipPrice+"元</dd>");
            builder.Append("<dd class=\"FontThree\">会员价:"+item[i].MemberPrice+"元</dd><dd class=\"FontFour\">市场价:"+item[i].AgoraPrice+"元</dd></dl>");
