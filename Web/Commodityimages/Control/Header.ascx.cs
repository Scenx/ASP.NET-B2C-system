...
public partial class Control_Header : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Session["CommodityimagesName"] != null)
            {
                ...
                linkReet.Visible = true;
                LabelWelcome.Text = "欢迎您：" + Session["CommodityimagesName"].ToString();
            }
            else {
    ...
    public void BindDataItem()
    {
        ...
        for (int i = 0; i < item.Count; i++)
        {
            ...
            builder.Append("<span class=\"FontTwo\">Vip价格:" + item[i].VipPrice.ToString() + "元</span><span class=\"FontThree\">会员价:" + item[i].MemberPrice + "元</span></td>");
        }
    ...
    public void BindDataCategory() {
        ...
        IList<CategoryInfo> category = bll.GetCategory();
        StringBuilder builder = new StringBuilder();
        builder.Append("<div class=\"NavOne\" id=\"div6\"><ul><li class=\"NavOne_li1\"><a href=\"Index.aspx\">首 页</a></li><li class=\"NavOne_li2\"></li>");
        ...
        builder.Append("<div class=\"NavOne\" id=\"div66\"><ul><li class=\"NavOne_li1\"><a href=\"Index.aspx\">帮助中心</a></li><li class=\"NavOne_li2\"></li>");
    ...
    protected void linkReet_Click(object sender, EventArgs e)
    {
        Session["CommodityimagesName"] = null;
