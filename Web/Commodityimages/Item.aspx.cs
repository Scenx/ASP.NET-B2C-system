...
public partial class ItemPage : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["Id"] != null)
        {
            ...
            txtTitle = bll.GetTitle(txtRequestId)+"  电子商务系统网";
    ...
    protected void Shopping_Click(object sender, ImageClickEventArgs e)
    {
        ...
        else
        {
            ...
            OrderInfo info = new OrderInfo(DateTime.Now.ToString("yyyyMMddHHmmss"), Session["CommodityimagesName"].ToString(), txtItemName, decimal.Parse(txtItemPrice), 1);
