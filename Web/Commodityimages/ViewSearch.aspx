                ...
                <ContentTemplate>
                    <table width="720" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td width="80" height="35" align="left" valign="top">
                                <p>
                                    商品的类别：&nbsp;</p>
                            </td>
                            <td width="380" align="left" valign="top">
                                <asp:DropDownList ID="SelectCategory" runat="server" Width="110px" AutoPostBack="True"
                                    OnSelectedIndexChanged="SelectCategory_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td height="35" align="left" valign="top">
                                <asp:DropDownList ID="SelectProduct" runat="server" Width="108px">
                        ...
                        <tr>
                            ...
                            <td height="35" align="left" valign="top">
                                <input name="text" type="text" id="PriceStart" runat="server" style="width: 60px" />
                                -
                                <input name="text" type="text" id="PriceEnd" runat="server" style="width: 60px" />
                                元 按会员价搜索(例如10-50.55)<asp:RegularExpressionValidator ID="RegularExpressionValidator1"
                                    runat="server" ControlToValidate="PriceStart" ErrorMessage="*" ValidationExpression="^\d{1,4}\.\d{1,2}$|^\d{1,4}$"></asp:RegularExpressionValidator>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="PriceEnd"
                                    ErrorMessage="*" ValidationExpression="^\d{1,4}\.\d{1,2}$|^\d{1,4}$"></asp:RegularExpressionValidator><span
                                        id="spanPrice"></span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td height="35" align="left" valign="top">
                                <input name="text" type="text" id="ItemName" runat="server" onfocus="CheckPrice()"
                                    style="width: 262px" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td height="35" align="left" valign="top">
                                <asp:Button ID="ButtonSearch" runat="server" Text="高级搜索" BackColor="#E0E0E0" BorderColor="Gray"
                                    BorderWidth="1px" OnClick="ButtonSearch_Click" />
                            </td>
                        </tr>
                    </table>
                </ContentTemplate>
